...
public class UpdateMovieImpl implements UpdateService<MovieDto, Integer> {
    ...
    public MovieDto update(Integer idMovie, MovieDto movieDto) {
        ...
        MovieEntity movieEntityUpdated = this.updateMovie(idMovie, movieDto);
        return this.toDto(movieDto, movieEntityUpdated);
    }
    ...
    private MovieEntity updateMovie(Integer idMovie, MovieDto movieDto) {
        ...
        movieEntity.setGenres(listGenresEntities);
        ...
        movieEntity.setLanguages(listLanguagesEntities);
    ...
    private void setDataListLanguages(MovieDto movieDto, MovieDto movieDtoCreated) {
        ...
        listLanguagesDtos = getListLanguagesFull(movieDto, listLanguagesDtos);
